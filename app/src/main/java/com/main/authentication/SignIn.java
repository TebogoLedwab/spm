...
public class SignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signIn.setOnClickListener(v -> {
            ...
            if (validateInputs(emailInput, passwordInput, email, password)) {
                signInUser(email, password);
            }
        });
    }

    private boolean validateInputs(EditText emailInput, EditText passwordInput, String email, String password) {
        if (email.isEmpty()) {
